...
function saveIntegration(){
	...
	var tableRow = {clientName:"client1",integrationName:trimValue($("#integrationName").val()),integrationType:trimValue($("#integrationType").val()),username:"Juhi"};
	console.log(JSON.stringify(tableRow));
...
<input type="hidden" id="hiddenMsorValue" name="hiddenMsorValue" value="">
	<div class="container-fluid">
		...
		<!-- Logo and Mobile Toggle Icon Start -->
			...
			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 text-center pgTitle">CRM-DASHBOARD <span id="titleHeading"></span></div>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<form id="lookupFileUpload" class="form-horizontal">
				...
				<div class="modal-footer">
					<button id="closeBtn" type="button" class="btn btn-info bdRadNone foundry-blue-btn" data-dismiss="modal" id="cancelFileUploadPopUp">Close</button>
