...
<%-- <link rel="icon" type="image/png" sizes="16x16" href="${pageContext.request.contextPath}/resources/images/fav/favicon-foundry.png"> --%>
...
<script>
var ssgMandatoryFields = "${ldUiPropertyConfig.ssgMandatoryFields}";
...
var ssgMandatoryField='';
var ssgMandatoryFieldLength=0;
...
var ssgJsonFields = "${ldUiPropertyConfig.ssgJsonFields}";
...
if(ssgMandatoryFields != null && ssgMandatoryFields != "") {
	ssgMandatoryField = ssgMandatoryFields.split(",");
	ssgMandatoryFieldLength = ssgMandatoryField.length;
}
...
$(document).ready(function(){
	...
	$(document).attr("title", "Update Datapass - CRM");
...
function filterClientNameDropdown() {
	 ...
	 if($("#clientSpecificJson").val() !=null && $("#clientSpecificJson").val() !="" && $("#clientSpecificJson").val() != "undefined"){
					...
					for(var a=0;a<=integrationMappingArr.length;a++){
						if(integrationMappingArr[a] != null && integrationMappingArr[a] != "" && integrationMappingArr[a] !="undefined"){
							if(Object.keys(integrationMappingArr[a]) != null && Object.keys(integrationMappingArr[a]) !="" && Object.keys(integrationMappingArr[a]) !="undefined"){
								if($("#ssgjsonfield_"+i).val() == Object.keys(integrationMappingArr[a])){
									if(ssgJsonFields.indexOf(Object.keys(integrationMappingArr[a])) != -1){
										$("#jsonssgnamevalue_"+i).val(Object.keys(integrationMappingArr[a]));
		 ...
		 if(recArr[index].integrationDetailList.mandatoryfields !=null && recArr[index].integrationDetailList.mandatoryfields !="" && recArr[index].integrationDetailList.mandatoryfields !="undefined"){
			 ...
			 for(var i=0;i<mendatoryFieldsArr.length;i++){
				 if(ssgMandatoryFieldLength > 0) {
						for(var j=0; j<ssgMandatoryFieldLength; j++) {
						...
						if(customMappingArr[a] != null && customMappingArr[a] != "" && customMappingArr[a] !="undefined"){
							if(Object.keys(customMappingArr[a]) != null && Object.keys(customMappingArr[a]) !="" && Object.keys(customMappingArr[a]) !="undefined"){
								if(a==0){
									...
									$("#ssgcustomfield_"+a).val(Object.keys(customMappingArr[a]));
									...
									for(var i=0;i<mendatoryFieldsArr.length;i++){
										if($("#ssgcustomfield_"+a).val() == mendatoryFieldsArr[i]){
							...
							if(customMappingForMyFreshWorksArr[a] != null && customMappingForMyFreshWorksArr[a] != "" && customMappingForMyFreshWorksArr[a] !="undefined"){
								if(Object.keys(customMappingForMyFreshWorksArr[a]) != null && Object.keys(customMappingForMyFreshWorksArr[a]) !="" && Object.keys(customMappingForMyFreshWorksArr[a]) !="undefined"){
									if(a==0){
										...
										$("#ssgcustomfieldformyfreshworks_"+a).val(Object.keys(customMappingForMyFreshWorksArr[a]));
										...
										for(var i=0;i<mendatoryFieldsArr.length;i++){
											if($("#ssgcustomfieldformyfreshworks_"+a).val() == mendatoryFieldsArr[i]){
  ...
  function loadMappingDetails() {
		...
		if(ssgMandatoryFieldLength > 0) {
			var remainder = ssgMandatoryFieldLength % 2;
			
			var rowsToAdd = 0;
			if(remainder > 0) {
				rowsToAdd = 1;
			}
			var numberOfRows = Math.floor(ssgMandatoryFieldLength / 2) + rowsToAdd;
			...
			for (var i=1;i<=numberOfRows;i++) {
				...
				for(var j=index;j<index+2;j++) {
					if(ssgMandatoryField[j] != null && ssgMandatoryField[j] != "") {
						columnData = columnData+"<td><label id='msorField_"+j+"' class='control-label'>"+ssgMandatoryField[j]+"</label></td>"+
						...
						"<td><span class='input-group-addon'><input type='checkbox' id='outputFieldChk_"+j+"' aria-label='...'></span></td></td><td><button type='button' class='btn btn-info btn-sm' onclick=callContactMapCsf("+j+",false,'ssgField') title='Apply Functions'>F(x)</button></td><td><button type='button' class='btn btn-info btn-sm' onclick=applyLookups("+j+",false,'ssgField') title='Apply Lookups'>Lookup</button></td><td class='sep'></td>";
					}
				}
				/*for(var j=index;j<index+2;j++) {
					if(ssgMandatoryField[j] != null && ssgMandatoryField[j] != "") {
						...
						"<span class='input-group-addon'><input type='checkbox' id='outputFieldChk_"+j+"' aria-label='...'></span></div></td><td><button type='button' class='btn btn-info btn-sm' onclick=applyLookups("+j+",false,'ssgField') title='Apply Lookups'>Lookup</button></td><td class='sep'></td>";
					}
				}*/
	...
	function showCustomFieldTextBox() {
		...
		//var $addNew = $("<div class='input-group'><input type='text' placeholder='SSG Name' id='ssgcustomfield_"+compCountForCustomField+"' onkeyup='checkSsgField("+compCountForCustomField+")'><input type='text' placeholder='API Name' id='apicustomfield_"+compCountForCustomField+"'><input type='checkbox' id='chkboxcustomfield_"+compCountForCustomField+"' aria-label='...'><button type='button' id='functionButtoncustomfield_"+compCountForCustomField+"' class='btn btn-info btn-sm' onclick='callContactMapCsf("+compCountForCustomField+",true, 'ssgcustomfield_"+compCountForCustomField+"')' title='Apply Functions' disabled>F(x)</button><span class='input-group-append'><button id='addMultipleCustomFieldTextBox' onclick='callMultipleCustomFieldTextBox()' type='button' class='btn btn-info btn-sm' title='Add More Custom Fields'><span class='fa fa-plus' aria-hidden='true'></span></div>");
	...
	function callMultipleCustomFieldTextBox(){
		if(compCountForCustomField < customFieldLength) {
			...
			//var $addNew = $("<div class='input-group'><input type='text' placeholder='SSG Name' id='ssgcustomfield_"+compCountForCustomField+"' onkeyup='checkSsgField("+compCountForCustomField+")'><input type='text' placeholder='API Name' id='apicustomfield_"+compCountForCustomField+"'><input type='checkbox' id='chkboxcustomfield_"+compCountForCustomField+"' aria-label='...'><button type='button' id='functionButtoncustomfield_"+compCountForCustomField+"' class='btn btn-info btn-sm' onclick='callContactMapCsf("+compCountForCustomField+",true, 'ssgcustomfield_"+compCountForCustomField+"')' title='Apply Functions' disabled>F(x)</button><span class='input-group-append'><button type='button' class='delProgram btn btn-danger btn-sm'><span class='fa fa-times' aria-hidden='true'></span></div>");
	...
	function showCustomFieldTextBoxForMyFreshWorks() {
		...
		var $addNew = $("<div class='input-group'><input type='text' placeholder='SSG Name' id='ssgcustomfieldformyfreshworks_"+compCountForMyFreshWorksCustomField+"' onkeyup='checkSsgFieldForMyFreshWorks("+compCountForMyFreshWorksCustomField+")'><input type='text' placeholder='API Name' id='apicustomfieldformyfreshworks_"+compCountForMyFreshWorksCustomField+"'><input type='checkbox' id='chkboxcustomfieldformyfreshworks_"+compCountForMyFreshWorksCustomField+"' aria-label='...'><button type='button' id='functionButtoncustomfieldformyfreshworks_"+compCountForMyFreshWorksCustomField+"' class='btn btn-info btn-sm' onclick=callContactMapCsf("+compCountForMyFreshWorksCustomField+",true,'customFieldForMyFreshWorks') title='Apply Functions' disabled>F(x)</button><button type='button' class='btn btn-info btn-sm' onclick=applyLookups("+compCountForMyFreshWorksCustomField+",true,'customFieldForMyFreshWorks') title='Apply Lookups'>Lookup</button><span class='input-group-append'><button id='addMultipleCustomFieldTextBoxForMyFreshWorks' onclick='callMultipleCustomFieldTextBoxForMyFreshWorks()' type='button' class='btn btn-info btn-sm' title='Add More Custom Fields'><span class='fa fa-plus' aria-hidden='true'></span></div>");
	...
	function showJsonFieldTextBox() {
		var $addNew = $("<tr><td><input type='text' class='form-control form-control-sm' id='ssgjsonfield_"+compCountForJsonField+"' onkeyup='checkJsonField("+compCountForJsonField+")' disabled></td><td><select id='jsonssgnamevalue_"+compCountForJsonField+"' class='form-control form-control-sm' name='jsonssgnamevalue'></select></td><td><input type='checkbox' id='chkboxjsonfield_"+compCountForJsonField+"' aria-label='...'></td><td><button type='button' id='functionButtonjsonfield_"+compCountForJsonField+"' class='btn btn-info btn-sm' onclick=callContactMapCsf("+compCountForJsonField+",false,'jsonField') title='Apply Functions' >F(x)</button></td><td><button type='button' class='btn btn-info btn-sm' onclick=applyLookups("+compCountForJsonField+",false,'jsonField') title='Apply Lookups'>Lookup</button></td></tr>");
		$("#addJsonFieldDiv").append($addNew);
		$("#jsonssgnamevalue_"+compCountForJsonField).html(jsonFieldValue);
	...
	function updateIntegration(){
		...
		debugger;
		if(ssgMandatoryFieldLength > 0 && ($("#clientSpecificJson").val() == null || $("#clientSpecificJson").val() == "")) {
			for(var i=0; i<ssgMandatoryFieldLength; i++) {
				...
				if($("#ssgcustomfield_"+i).val() != null && $("#ssgcustomfield_"+i).val() != "" && $("#ssgcustomfield_"+i).val() != "undefined") {
					ssFieldJsonObject.json[$("#ssgcustomfield_"+i).val()] = $("#apicustomfield_"+i).val();
					if($("#apicustomfield_"+i).val() != null && $("#apicustomfield_"+i).val() != "" && $("#apicustomfield_"+i).val() != "undefined"){
						if($("#chkboxcustomfield_"+i).is(':checked')) {
							mandatoryFieldsArray.push($("#ssgcustomfield_"+i).val()); 
						}
					}
					deportFieldsArray.push($("#ssgcustomfield_"+i).val());
				}
				
				if(($("#ssgcustomfieldformyfreshworks_"+i).val() != null && $("#ssgcustomfieldformyfreshworks_"+i).val() != "" && $("#ssgcustomfieldformyfreshworks_"+i).val() != "undefined") &&  
						...
						ssFieldJsonObjectForMyFreshWorks.json[$("#ssgcustomfieldformyfreshworks_"+i).val()] = $("#apicustomfieldformyfreshworks_"+i).val();
							
						if($("#chkboxcustomfieldformyfreshworks_"+i).is(':checked')) {
							mandatoryFieldsArray.push($("#ssgcustomfieldformyfreshworks_"+i).val()); 
						}
						deportFieldsArray.push($("#ssgcustomfieldformyfreshworks_"+i).val());
				}
		...
		}else if(ssgMandatoryFieldLength > 0 && ($("#clientSpecificJson").val() != null || $("#clientSpecificJson").val() != "") && ($("#integrationType").val() == "sftp_client" || $("#integrationType").val() == "mkto_bulk_import")) {
			$("#clientSpecificJson").val("");
			for(var i=0; i<ssgMandatoryFieldLength; i++) {
				if(($("#msorField_"+i).text() != null && $("#msorField_"+i).text() != "" && $("#msorField_"+i).text() != "undefined") &&  
					($("#outputField_"+i).val() != null && $("#outputField_"+i).val() != "" && $("#outputField_"+i).val() != "undefined" && $("#outputField_"+i).val() != "N/A")) {
			...
			if(jsonFieldDataLength > 0){
				...
				for(var i=0; i<jsonFieldDataLength; i++) {
					if($("#ssgjsonfield_"+i).val() != null && $("#ssgjsonfield_"+i).val() != "" && $("#ssgjsonfield_"+i).val() != "undefined") {
						if($("#jsonssgnamevalue_"+i).val() != null && $("#jsonssgnamevalue_"+i).val() != "" && $("#jsonssgnamevalue_"+i).val() !="undefined"){
							ssFieldJsonObject.json[$("#jsonssgnamevalue_"+i).val()] = $("#ssgjsonfield_"+i).val();
							clientSpecificJsonMapping = clientSpecificJsonMapping.replace("|!"+$("#ssgjsonfield_"+i).val()+"!|","|!"+$("#jsonssgnamevalue_"+i).val()+"!|");
							if($("#chkboxjsonfield_"+i).is(':checked')) {
								mandatoryFieldsArray.push($("#jsonssgnamevalue_"+i).val());
							}
							deportFieldsArray.push($("#jsonssgnamevalue_"+i).val());
							
						}else{
							ssFieldJsonObject.json[$("#ssgjsonfield_"+i).val()] = $("#ssgjsonfield_"+i).val();
							if($("#chkboxjsonfield_"+i).is(':checked')) {
								mandatoryFieldsArray.push($("#ssgjsonfield_"+i).val()); 
							}
							deportFieldsArray.push($("#ssgjsonfield_"+i).val());
						}
					}
				}
	...
	function callContactMapCsf(value, customField, msorValue){
		debugger;
		var fields="";
		if(msorValue =="ssgField"){
			fields = $('#msorField_'+value).text();
			isCustomFieldForMyFreshWorks = false;
		}else if(msorValue =="customFieldForMyFreshWorks"){
			fields = $('#ssgcustomfieldformyfreshworks_'+value).val();
			isCustomFieldForMyFreshWorks = true;
		}else if(msorValue =="jsonField"){
			fields = $('#jsonssgnamevalue_'+value).val();
			isCustomFieldForMyFreshWorks = false;
		}else{
			fields = $('#ssgcustomfield_'+value).val();
			isCustomFieldForMyFreshWorks = false;
		}
		
		//var abc = $('#ssgcustomfield_'+value).val();
		//alert("fields::"+fields);
			...
			if(validationObj !=null && validationObj != ""){
				...
				if(validationMatching == true) {
					...
					if(Object.keys(validationJsonObject).length > 0) {
						debugger;
						if($("#clientSpecificJson").val() !=null && $("#clientSpecificJson").val() !="" && $("#clientSpecificJson").val() !="undefined"){
							if($("#jsonssgnamevalue_"+csfValidationValue).val() != null && $("#jsonssgnamevalue_"+csfValidationValue).val() != "" && 
									$("#jsonssgnamevalue_"+csfValidationValue).val() != "undefined") {
								finalJson[$("#jsonssgnamevalue_"+csfValidationValue).val()] = validationJsonObject;
							}
						}else{
							if($("#msorField_"+csfValidationValue).text() != null && $("#msorField_"+csfValidationValue).text() != "" && 
								...
								if($("#ssgcustomfield_"+csfValidationValue).val() != null && $("#ssgcustomfield_"+csfValidationValue).val() != "" && 
									$("#ssgcustomfield_"+csfValidationValue).val() != "undefined" && isCustomField && !isCustomFieldForMyFreshWorks) {
									
									finalJson[$("#ssgcustomfield_"+csfValidationValue).val()] = validationJsonObject;
								}
								if($("#ssgcustomfieldformyfreshworks_"+csfValidationValue).val() != null && $("#ssgcustomfieldformyfreshworks_"+csfValidationValue).val() != "" && 
										$("#ssgcustomfieldformyfreshworks_"+csfValidationValue).val() != "undefined" && isCustomField && isCustomFieldForMyFreshWorks) {
										
										finalJson[$("#ssgcustomfieldformyfreshworks_"+csfValidationValue).val()] = validationJsonObject;
								}
						}
						debugger;
	...
	function applyLookups(index, customField, msorValue) {
		...
		if(msorValue =="ssgField"){
			...
			fields = $('#ssgcustomfieldformyfreshworks_'+index).val();
			isCustomFieldForMyFreshWorks = true;
		}else if(msorValue =="jsonField"){
			fields = $('#jsonssgnamevalue_'+index).val();
			isCustomFieldForMyFreshWorks = false;
		}else{
			fields = $('#ssgcustomfield_'+index).val();
			isCustomFieldForMyFreshWorks = false;
		}
		...
		if(customField) {
			if(isCustomFieldForMyFreshWorks){
				$("#lookupType").val($("#ssgcustomfieldformyfreshworks_"+index).val());
			}else{
				$("#lookupType").val($("#ssgcustomfield_"+index).val());
			}
		}
		else {
			if($("#clientSpecificJson").val() !=null && $("#clientSpecificJson").val() !="" && $("#clientSpecificJson").val() !="undefined"){
				if($("#jsonssgnamevalue_"+index).val() != null && $("#jsonssgnamevalue_"+index).val() != "" && 
						$("#jsonssgnamevalue_"+index).val() != "undefined") {
					$("#lookupType").val($("#jsonssgnamevalue_"+index).val());
				}
			}else{
				...
				if($("#clientSpecificJson").val() !=null && $("#clientSpecificJson").val() !="" && $("#clientSpecificJson").val() !="undefined"){
					...
					if($("#msorField_"+csfValidationValue).text() != null && $("#msorField_"+csfValidationValue).text() != "" && 
						...
						if($("#ssgcustomfield_"+csfValidationValue).val() != null && $("#ssgcustomfield_"+csfValidationValue).val() != "" && 
								...
								//finalOthersLookupJson[$("#ssgcustomfield_"+csfValidationValue).val()] = finalOthersLookup;
								finalOthersLookupJson[$("#lookup_parent").val()] = finalOthersLookup;
						}
						if($("#ssgcustomfieldformyfreshworks_"+csfValidationValue).val() != null && $("#ssgcustomfieldformyfreshworks_"+csfValidationValue).val() != "" && 
								$("#ssgcustomfieldformyfreshworks_"+csfValidationValue).val() != "undefined" && isCustomField && isCustomFieldForMyFreshWorks) {
								
								//finalOthersLookupJson[$("#ssgcustomfieldformyfreshworks_"+csfValidationValue).val()] = finalOthersLookup;
								finalOthersLookupJson[$("#lookup_parent").val()] = finalOthersLookup;
						}
				}
				debugger;
	...
	function checkSsgField(value){
		if($("#ssgcustomfield_"+value).val() != null && $("#ssgcustomfield_"+value).val() != "" && $("#ssgcustomfield_"+value).val() != "undefined") {
	...
	function checkSsgFieldForMyFreshWorks(value){
		if($("#ssgcustomfieldformyfreshworks_"+value).val() != null && $("#ssgcustomfieldformyfreshworks_"+value).val() != "" && $("#ssgcustomfieldformyfreshworks_"+value).val() != "undefined") {
	...
	function addStaticList(index, customField, msorValue) {
		...
		var type ='';
		if(customField){
			type = $("#ssgcustomfield_"+index).val();
		...
		if(data != null && data != "" && data != "undefined") {
			...
			if(dataArr.length > 0){
				for(var i=0;i<dataArr.length;i++){
					var $addNew = $("<div class='input-group'><input type='text' placeholder='Name' id='ssgaddStaticList_"+i+"' disabled ><input type='text' placeholder='Value' id='apiaddStaticList_"+i+"'></div>");
					$("#addStaticListColumns").append($addNew);
					$("#ssgaddStaticList_"+i).val(dataArr[i]);
				}
			}
		}
	}
	...
	function saveStaticList(){
		debugger;
		//var ssgKey = $("#staticListType").val();
		var ssStaticFieldJsonObject = {};
		var staticFieldJsonObject = {};
		if(dataArrForSave.length > 0){
			for(var i=0;i<dataArrForSave.length;i++){
				if($("#apiaddStaticList_"+i).val() == ""){
					$("#staticListErrorMsg").html("* Kindly provide value for "+$("#ssgaddStaticList_"+i).val()).show();
					setTimeout(function(){$('#staticListErrorMsg').html("");},4000);
					return false;
				}
				staticFieldJsonObject[$("#ssgaddStaticList_"+i).val()] = $("#apiaddStaticList_"+i).val();
			}
		}
				...
				if(jsonFieldsArr != null && jsonFieldsArr != "" && jsonFieldsArr.length > 0){
					for(var a=0;a<=jsonFieldsArr.length;a++){
						if(jsonFieldsArr[a] != null && jsonFieldsArr[a] != "" && jsonFieldsArr[a] !="undefined"){
							...
							$("#ssgjsonfield_"+a).val(jsonFieldsArr[a]);
							if(ssgJsonFields != null && ssgJsonFields != "") {
								var ssgJsonFieldArr = ssgMandatoryFields.split(",");
								for(var x=0;x<=ssgJsonFieldArr.length;x++){
									if(jsonFieldsArr[a] == ssgJsonFieldArr[x]){
										$("#jsonssgnamevalue_"+a).val(jsonFieldsArr[a]);
										//document.getElementById('functionButtonjsonfield_'+a).disabled = false;
							...
							if(!checkMatchFound){
								$("#jsonssgnamevalue_"+a).html(jsonFieldValue);
							}
						}
					}
				}
...
<div class="container-fluid">
		...
		<!-- Logo and Mobile Toggle Icon Start -->
			...
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 text-center pgTitle">CRM <span id="titleHeading"></span></div>
		...
		<div class="modal-content">
			<form id="addClient" class="form-horizontal">
										...
										<div class="col-md-12 margT10">
											<div class="table-responsive">
												<table id="contMap" class="margBNone table table-bordered table-condensed table-striped">
													<thead>
														<tr>
															<th class="tHeadBlue">Foundry Fields</th>
									...
									<div class="row">
										<div class="col-md-12 margT10">
											<table id="jsonMapTable" class="margBNone table table-bordered table-condensed table-striped">
													...
													<th width="300px">Foundry Fields</th>
				...
				<div class="modal-footer">
					<button id="closeBtn" onclick="closeAddNewIntegrationModel()" type="button" class="btn btn-default bdRadNone foundry-blue-btn mr-0" >Close</button>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<form id="addsendTestLead" class="form-horizontal">
				...
				<div class="modal-footer">
					<button id="closeBtn" onclick="closeSendTestLeadModel()" type="button" class="btn btn-default bdRadNone btn-c foundry-blue-btn" data-dismiss="modal">Close</button>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<form id="fileUpload" class="form-horizontal">
				...
				<div class="modal-footer">
					<button id="closeClientValidationBtn" type="button" onclick="closeCSVModel()" class="btn btn-default bdRadNone foundry-blue-btn" data-dismiss="modal">Close</button>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<form id="lookupFileUpload" class="form-horizontal">
				...
				<div class="modal-footer">
					<button id="closeBtn" type="button" class="btn btn-default bdRadNone foundry-blue-btn" data-dismiss="modal" id="cancelFileUploadPopUp">Close</button>
